    ...
    <div class="erp-card-body p-0">
        <div class="table-responsive erp-table-wrap">
            <table class="table erp-table mb-0">
                ...
                <?php foreach ($data['rows'] as $o): ?>
                    <tr>
                        ...
                        <td class="actions-cell">
                            <?php if ($this->data['canEdit']): ?><a href="<?= $this->url('/sales/orders/' . (int) $o['id'] . '/edit') ?>" class="btn btn-sm btn-outline-primary btn-icon" title="Edit"><i class="bi bi-pencil"></i></a><?php endif; ?>
                ...
                <?php endforeach; ?>
                <?php if (!$data['rows']): ?>
                    <tr><td colspan="7"><div class="empty-state"><i class="bi bi-clipboard-check"></i>No sales orders yet.</div></td></tr>
                <?php endif; ?>
                </tbody>
            </table>
        </div>
